                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={style.Produtos}>
                            ...
                            <TouchableOpacity style={style.deleteProduto} onPress={() => excluirFornecedor(item.id)}>
                                <FontAwesome name="trash" size={20} color="#007bff" />
                            </TouchableOpacity>
                        </View>
                    )}
                />
                <TouchableOpacity style={style.buttonNewProduto} onPress={() => navigation.navigate("IncluirFornecedor")}>
